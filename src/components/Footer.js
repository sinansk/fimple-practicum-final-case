const Footer = () => {
  return (
    <div className="h-20 mt-auto absolute-0 right-0 left-0 sm:h-[12vh] w-full flex z-20 justify-center items-center bg-orange-400 dark:bg-slate-800 fixed inset-x-0 bottom-0">
